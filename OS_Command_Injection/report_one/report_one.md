...
- We can use others techniques that allow us to detect if it is Blind or not, like injecting command to trigger a time delay like `ping` command. 
...
## Recommendation:
- Validate that the input should only be numbers.
